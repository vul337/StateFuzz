...
type RPCInput struct {
	...
	SvSignal       signal.Serial
	PcCover        []uint32
	ProgPcCover    []uint32
	SvCover        signal.SvSerial
	ProgSvCover    signal.SvSerial
	SvPrio         int64
	TimeStamp      int64
	IsNewSvSeed    int8
	PathHash       uint32
...
type PollArgs struct {
	...
	MaxSvSignal       signal.Serial
	MaxSvCover        signal.SvSerial
