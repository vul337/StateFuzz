...
enum CoverageFeature {
  ...
  CoverageTracePCWithSVRanges = 1 << 16,
};
...
SanitizerArgs::SanitizerArgs(const ToolChain &TC,
  ...
  int InstrumentationTypes = CoverageTracePCWithSVRanges | CoverageTracePC | CoverageTracePCGuard |
  ...
  if (!(CoverageFeatures & InsertionPointTypes)) {
    if (CoverageFeatures &
        (CoverageTracePCWithSVRanges | CoverageTracePC | CoverageTracePCGuard | CoverageInline8bitCounters |
         CoverageInlineBoolFlag))
...
void SanitizerArgs::addArgs(const ToolChain &TC, const llvm::opt::ArgList &Args,
  ...
  std::pair<int, const char *> CoverageFlags[] = {
      ...
      std::make_pair(CoverageTracePCWithSVRanges, "-fsanitize-coverage-trace-pcwithsvranges"), // added by sgh0t
...
int parseCoverageFeatures(const Driver &D, const llvm::opt::Arg *A) {
  ...
  for (int i = 0, n = A->getNumValues(); i != n; ++i) {
    ...
    int F = llvm::StringSwitch<int>(Value)
                ...
                .Case("trace-pcwithsvranges", CoverageTracePCWithSVRanges) // added by sgh0t
