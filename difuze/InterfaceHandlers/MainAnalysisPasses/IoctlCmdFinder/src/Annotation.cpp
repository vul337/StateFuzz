...
bool KIntAnnotation::needAnnotation(Value *V) {
...
//
inline bool KIntAnnotation::isAllocFn(StringRef name, int *size, int *flag) {
...
std::string KIntAnnotation::getStoreId(StoreInst *SI) {
...
std::string KIntAnnotation::getLoadId(LoadInst *LI) {
...
std::string KIntAnnotation::getStructId(Value *PVal, User::op_iterator &IS, User::op_iterator &IE, Module *M) {
...
std::string KIntAnnotation::getAnonStructId(Value *V, Module *M, StringRef Prefix) {
...
std::string KIntAnnotation::getAnnotation(Value *V, Module *M) {
